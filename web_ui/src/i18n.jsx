...
const translations = {
  de: {
    ...
    'results.copy': 'Volltext kopieren',
  ...
  fr: {
    ...
    'results.copy': 'Copier le texte intégral',
  ...
  it: {
    ...
    'results.copy': 'Copia testo integrale',
  ...
  rm: {
    ...
    'results.copy': 'Copiar text cumplain',
    'results.copied': '✓ Copià',
    'btn.filters': 'Filters',
    ...
    'settings.ollamaConnected': 'Connectà',
