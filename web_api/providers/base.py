...
SYSTEM_PROMPT = (
    ...
    "## Presenting results\n"
    "- Cite decisions by docket number and date (e.g. BGer 6B_123/2024 vom 15.01.2025).\n"
    "- When listing search results, include: court, date, docket number, brief summary.\n"
