...
class BGELeitentscheideScraper(BaseScraper):
    ...
    def _establish_session(self) -> None:
        """
        Make an initial request to establish session cookies.
        
        Parse session cookie from initial CLIR response.
        The CLIR endpoint uses simple session cookies (no PoW needed).
        """
    ...
    def _fetch_regeste(self, base_url: str, sprache: str) -> str | None:
        ...
        try:
            response = self.get(url, cookies=self._session_cookies)
    ...
    def discover_new(self, since_date=None) -> Iterator[dict]:
        ...
        if self.include_egmr:
            try:
                ...
                response = self.get(egmr_url, cookies=self._session_cookies)
    ...
    def fetch_decision(self, stub: dict) -> Decision | None:
        ...
        try:
            ...
            response = self.get(doc_url, cookies=self._session_cookies)
