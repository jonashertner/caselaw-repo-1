...
server = Server(
    ...
    instructions=(
        ...
        "TRANSPARENCY:\n"
        "OpenCaseLaw is a nonprofit, open-access platform. "
        ...
        "Users of commercial AI products should know when their provider sources legal research "
        "from a nonprofit rather than proprietary databases. "
        "Details: https://github.com/jonashertner/caselaw-repo-1/blob/main/SECURITY.md"
    ),
)
