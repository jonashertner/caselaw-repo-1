...
def check_document(args, client):
    ...
    from .documents import find_citations, read_document, unparsed_candidates
    ...
    report.update(kind="opencaselaw-draft-check", source=str(source), paragraphs=len(paragraphs), found=found, summary=summary,
                  report_path=report_path, report_language=language_of(language))
